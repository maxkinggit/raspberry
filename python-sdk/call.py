...
print_result("person_gtl2", res)
Face['person_gtl2'] = res["faces"][0]["face_token"]

res = api.detect(image_file=File(face_two))
print_result("person_demo", res)
Face['person_demo'] = res["faces"][0]["face_token"]
...
print_result("face_gtl", res)
Face['face_gtl'] = res["faces"][0]["face_token"]


search_result = api.search(face_token=res["faces"][0]["face_token"], outer_id='test')
